...
1. Performed exploratory data analysis to identify patterns and correlations.
2. Applied feature selection techniques to optimize input features for machine learning models.
